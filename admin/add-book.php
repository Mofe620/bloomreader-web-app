...
$sql ="INSERT into books (`BookName`, `AuthorID`, `ISBN`, `CategoryID`, `PRICE`, `RegDate`, `STATUS`) 
		VALUES ( '$bookName', '$author', '$isbn', '$category', '$price', NOW(), '$status' ) ";
        if ($conn->query($sql) === TRUE) {

        $_SESSION['msg'] = '<div class="alert alert-success"><strong>Success: </strong>Book has been added.
        					<button type="button" class="close" data-dismiss="alert">×</button></div>';
        header('location:books.php');

    } else {
    	$_SESSION['msg'] = '<div class="alert alert-error"><strong>Error: </strong>Book could not be added.
        					<button type="button" class="close" data-dismiss="alert">×</button></div>';
        header('location:books.php');
						...
						<div class="module-body">
							<div class="control-group">
								<div class="controls row-fluid">
									...
									<input class="span12" name="bookName" type="text" id="bookName" value="" required>
								</div>
							</div>
							<div class="control-group">
							...
							<div class="control-group">
								<div class="controls row-fluid">
									...
									<input class="span12" name="isbn" type="text" id="catName" value="" required>
								</div>
							</div>
							<div class="control-group">
								<label class="control-label" for="basicinput">Category</label>
								<div class="controls">
									<select name="category" tabindex="1" data-placeholder="Select category" class="span2">
							...
							<div class="control-group">
								<div class="controls row-fluid">
									...
									<input class="span12" name="price" type="number" id="catName" value="" required>
								</div>
							</div>
							<div class="control-group">
